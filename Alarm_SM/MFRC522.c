...
#define SET_PORT				PORTB = 0b11111111;
#define SET_DDR					DDRB  = 0b10111111;
#define HW_SPI_SELECT()   		PORTB &= ~(1<<4)
#define HW_SPI_UNSELECT() 		PORTB |= 1<<4

unsigned char SPI_transfer(unsigned char data)
{
	SPDR = data;					// send data via SPI - put in SPI Data Register
