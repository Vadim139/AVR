...
//    		Atm644.Rec_data((uint8_t*)&data);
    	}
    	else if(rqs_flag == 1 && data == ADDR && !rqs_proc)
    	{
    		rqs_flag = 0;
    		RS_Process();
//    		rqs_proc = 1;
...
//	UART_sendi(UART_RxHead);
//	uart_putc(' ');
//	UART_sendi(UART_RxTail);
//	uart_putc('\n');
//	uart_putc('\r');
//
//	while(!Is_Data());
