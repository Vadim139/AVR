...
#define	LD_an_1		SBIT( PORTD, 4 )
#define	LD_DDRan_1	SBIT( DDRD, 4 )

#define	LD_an_2		SBIT( PORTD, 5 )
#define	LD_DDRan_2	SBIT( DDRD, 5 )

#define	LD_an_3		SBIT( PORTD, 6 )
#define	LD_DDRan_3	SBIT( DDRD, 6 )
