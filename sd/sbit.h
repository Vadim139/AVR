...
// klawiatura
#define	ROW_1		SBIT( PORTC, 2 )
#define	ROW_R_1		SBIT( PINC, 2 )
#define	ROW_DDR_1	SBIT( DDRC, 2 )

#define	ROW_2		SBIT( PORTC, 3 )
#define	ROW_R_2		SBIT( PINC, 3 )
#define	ROW_DDR_2	SBIT( DDRC, 3 )

#define	ROW_3		SBIT( PORTC, 4 )
#define	ROW_R_3		SBIT( PINC, 4 )
#define	ROW_DDR_3	SBIT( DDRC, 4 )

#define	ROW_4		SBIT( PORTC, 5 )
#define	ROW_R_4		SBIT( PINC, 5 )
#define	ROW_DDR_4	SBIT( DDRC, 5 )
