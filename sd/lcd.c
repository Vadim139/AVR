...
//char str[8],str1[8],str2[8];
	...
	WriteSpiData(5); //16-Bit per Pixel
#else
	WriteSpiCommand(0x3A);
...
void LCDPutChar(char c, int x, int y, int size, char back, int fColor, int bColor) {
//	const unsigned char PROGMEM FONT6x8[97][8];
//	const unsigned char PROGMEM FONT8x8[97][8];
//	const unsigned char PROGMEM FONT8x16[97][16];
//	int i, j;
//	unsigned int nCols;
//	unsigned int nRows;
//	unsigned int nBytes;
...
//	pChar = pgm_read_byte(pFont + (nBytes * (c - 0x1F)) + nBytes - 1);
//	switch (back) {
//	case 1:
//		// Row address set (command 0x2B)
//		WriteSpiCommand(PASET);
