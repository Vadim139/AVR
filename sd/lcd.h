...
#define LCD_RESET_LOW PORTB &= ~(1 << 3);
#define LCD_RESET_HIGH PORTB |= (1 << 3);
// mask definitions
...
void LCDPutString (char *lcd_string, unsigned char x, unsigned char y, const char *font_style,char back, unsigned char fcolor, unsigned char bcolor);
#endif /* LCD_H_ */
