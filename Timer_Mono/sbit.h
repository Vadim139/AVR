...
#define	SW_1		SBIT( PORTB, 0 )
#define	SW_DDR_1	SBIT( DDRB, 0 )
#define	SWpin_1		SBIT( PINB, 0 )

#define	ADC_1		SBIT( PORTB, 4 )
#define	ADC_DDR_1	SBIT( DDRB, 4 )
#define	ADCin_1		SBIT( PINB, 4 )

#define	ADC_2		SBIT( PORTB, 2 )
#define	ADC_DDR_2	SBIT( DDRB, 2 )
#define	ADCin_2		SBIT( PINB, 2 )

#define	OUT_1		SBIT( PORTB, 1 )
#define	OUT_DDR_1	SBIT( DDRB, 1 )

#define	OUT_2		SBIT( PORTB, 3 )
#define	OUT_DDR_2	SBIT( DDRB, 3 )
